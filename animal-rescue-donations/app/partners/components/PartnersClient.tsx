  ...
  return (
    <div className="container mx-auto px-3 md:px-4 py-6 md:py-12">
      <div className="max-w-6xl mx-auto">
        {/* Hero Section */}
        <div className="card-gradient-gold p-4 md:p-12 mb-6 md:mb-12 relative overflow-hidden">
          <div className="absolute -top-10 -right-10 w-48 h-48 bg-yellow-200/30 rounded-full blur-3xl"></div>
          <div className="relative z-10 text-center">
            <span className="inline-flex items-center gap-2 bg-orange-500 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-full text-xs md:text-sm font-bold mb-3 md:mb-4">
              🤝 Our Heroes
            </span>
            <h1 className="text-2xl md:text-5xl font-extrabold text-gradient-gold mb-3 md:mb-4">
              Rescue Partners
            </h1>
            <p className="text-sm md:text-lg text-gray-700 max-w-2xl mx-auto px-2">
